...
query:
  ...
  ##
  stores: ["prometheus-prometheus-kube-prometheus-prometheus-0.prometheus-operated.monitoring:10901"]
...
ruler:
  ...
  ##
  alertmanagers: ["http://prometheus-kube-prometheus-alertmanager:9093"]
